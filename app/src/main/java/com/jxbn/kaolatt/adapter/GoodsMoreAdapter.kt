 ...
 * 首页的更多推荐
 */
class GoodsMoreAdapter:BaseQuickAdapter<GoodsMoreListBean.DataBean.RowsBean,BaseViewHolder>(R.layout.item_goods_list) {
    override fun convert(helper: BaseViewHolder, item: GoodsMoreListBean.DataBean.RowsBean?) {
        item?:return
