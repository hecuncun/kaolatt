 ...
 */
class GoodsListAdapter:BaseQuickAdapter<GoodListBean.DataBean,BaseViewHolder>(R.layout.item_goods_list) {
    override fun convert(helper: BaseViewHolder, item: GoodListBean.DataBean?) {
        ...
        GlideUtils.showAnimation(imgGoods,imgList[0],R.mipmap.logo)
    }
}