 ...
 * 首页的精品好物
 */
class GoodMoreListAdapter:BaseQuickAdapter<GoodMoreListBean.DataBean.RowsBean,BaseViewHolder>(R.layout.item_goods_list) {
    override fun convert(helper: BaseViewHolder, item:GoodMoreListBean.DataBean.RowsBean?) {
        item?:return
